...
SENSORS_GENERIC = [
    ...
    SensorEntityDescription(
        key='previous_billing_period_usage_total',
        name='Previous billing period usage: Total',
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
    ...
    SensorEntityDescription(
        key='previous_billing_period_cost_total_nominal',
        name='Previous billing period cost: Nominal Total',
        native_unit_of_measurement=CURRENCY_DOLLAR,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        icon="mdi:cash",        
    ...
    SensorEntityDescription(
        key='previous_billing_period_cost_total_effective',
        name='Previous billing period cost: Effective Total',
        native_unit_of_measurement=CURRENCY_DOLLAR,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        icon="mdi:cash",        
